...
def test_fileobject_meta(tmpdir):
    ...
    assert fo.meta == {
                        'file.path': path,
                        'file.name': 'fileobject-meta',
                        'file.name.sha256': 'd2088266c0fc064b249d1b9959c80d986cc72b377066ad80e7211837d57e6c09',
                        'file.name.pairtree': 'd2/08/d2088266c0fc064b249d1b9959c80d986cc72b377066ad80e7211837d57e6c09',
